    ...
    <div>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
            ...
            Ezixa Sport Wear Apparel is a leading manufacturer and retailer of high-quality, affordable sportswear and athletic apparel. Our mission is to provide comfortable, stylish, and functional clothing for athletes and fitness enthusiasts of all levels. Products: Men's Soccer Jersey. Men's All Sport Game Uniform. Men's Hooodies. Key Features:
